                                    ...
                                    <tbody>
                                        <c:forEach items="${categoryList}" var="category">
                                            <tr>
                                                ...
                                                <td>${category.desc}</td>
                                                <td>
                                                    <a class="btn btn-primary" href="EditCategoryServlet?categoryId=${category.id}">Edit</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-danger"  href="DeleteCategoryServlet?categoryId=${category.id}">Delete</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
