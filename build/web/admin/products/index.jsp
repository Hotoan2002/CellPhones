                                    ...
                                    <tbody>
                                        <c:forEach items="${productList}" var="product">
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary"  href="EditProductServlet?productId=${product.id}">Edit</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-danger"  href="DeleteProductServlet?productId=${product.id}">Delete</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
